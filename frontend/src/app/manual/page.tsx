          ...
          {isLoggedIn ? (
            <div >
              ...
              <div>
                ...
                <Image src={selectContent} alt = "selectContent" className="manualImage"/>
                <ol>
              ...
              <div>
                ...
                <Image src={defaultColours} alt = "defaultColours" className="manualImage"/>
                <ol>
                ...
                <Image src={customColours} alt = "customColours" className="manualImage"/>
                <ol>
